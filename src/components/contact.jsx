...
const Contact = () =>{
   ...
   return(
        <section id="contact" className="h-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center justify-center md:w-1/2 md:h-full w-full h-auto p-10" data-aos="zoom-in-left">
                <div className="p-3 my-16 w-4/5 h-auto bg-blue-950 rounded-2xl shadow-2xl shadow-blue-950">
