        ...
        <section id="contact" className="h-screen flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center justify-center md:w-1/2 md:h-full w-full h-auto p-10" data-aos="zoom-in-left">
                <div className="p-3 py-5 w-4/5 h-auto bg-blue-950 rounded-2xl shadow-2xl shadow-blue-950">
                    <p className="text-2xl font-poppins font-medium text-center text-white">Contact Me</p>
                    <form ref={form} onSubmit={sendEmail} className="w-full flex flex-col items-center justify-center">
                        <input type="text" placeholder="Fullname" name='user_name' required className="text-lg h-auto w-full p-2 my-3 rounded-lg font-poppins"/>
                        <input type="email" name="user_email" placeholder="Email" required className="text-lg h-auto w-full p-2 my-3 rounded-lg font-poppins"/>
                        <input type="text" name="subject" placeholder="Subject" required className="text-lg h-auto w-full p-2 my-3 rounded-lg font-poppins"/>
                        <textarea placeholder="Message" name="message" cols="30" rows="5" className="text-lg p-3 my-3 font-poppins w-full rounded-lg"></textarea>
