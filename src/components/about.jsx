...
const About = ()=>{
    ...
    return(
        <section id="about" className="h-auto flex flex-col md:flex-row items-center justify-center bg-blue-950 py-14">
            <figure className="w-2/3 h-3/4" data-aos="flip-left">
                <Lottie options={options} height="90%" width="90%" />
            </figure>
            <article className='md:w-2/4 h-auto w-3/4 my-16 mx-20' data-aos="flip-right">
                <p className='md:text-5xl text-3xl font-semibold font-poppins text-blue-600 text-right my-3 transition-all duration-300'>Want to know more?</p>
